...
##Make the change to change the matrices into species level
...
LssuspeciesOTURICH <- dcast(ssuspecies, ID ~ ssuspecies, value.var = "species_OTU_Richness",  fun.aggregate = sum )
LssuspeciesOTUREAD <- dcast(ssuspecies, ID ~ ssuspecies, value.var = "species_Read_Abundance",  fun.aggregate = sum )
